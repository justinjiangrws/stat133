...
family.30y <- family[family$age > 30,]
family.30y68i <- family.30y[family$height < 68,]
...
family2 <- data.frame(family$name, family$gender, family$age, family$height, family$weight, bmi)
